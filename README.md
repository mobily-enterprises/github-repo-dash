...
- The **coder** is the author unless the author is marked MIA (`coder` in body or `op_mia` label).
- When the author is MIA, the DRI becomes the **coder**.
...
- **MIA flags**: body flag `coder`, label flag `op_mia`; both configurable.
